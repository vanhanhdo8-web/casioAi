...
<body>
    ...
    <script>
        ...
        fetch('/chat', {
          ...
          .then(d => document.getElementById('apiStatus').innerHTML = '✅ Gemini đã sẵn sàng')
          .catch(e => document.getElementById('apiStatus').innerHTML = '❌ Lỗi kết nối Gemini');
    </script>
</body>
</html>
    """
...
def ai_chatbot_page():
    """Trang chatbot AI đầy đủ (giữ nguyên code HTML từ file cũ)"""
    html_content = """<!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
